...
namespace Silver.Mongo
{
    public class MongoUtil
    {
        ...
        public MongoUtil()
        {
            client = new MongoClient(ConfigurationUtil.GetSection("MongoDB:Connection"));
            database = client.GetDatabase(ConfigurationUtil.GetSection("MongoDB:Database"));
            this.databaseName = ConfigurationUtil.GetSection("MongoDB:Database");
        }

        public MongoUtil(string databaseName)
        { 
            client = new MongoClient(ConfigurationUtil.GetSection("MongoDB:Connection")); 
