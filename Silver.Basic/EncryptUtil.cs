...
namespace Silver.Basic
{
    public static class EncryptUtil
    {
        ...
        /// <returns></returns> 
        public static string ToDesEncrypt(this string strText, string strEncrKey)
        {
            try
            {
                byte[] byKey = null;
        ...
        /// <returns></returns> 
        public static string ToDesDecrypt(this string strText, string sDecrKey)
        {
            try
            {
                byte[] byKey = null;
        ...
        /// <param name="strEncrKey">密钥</param> 
        public static void ToDesEncryptFile(this string m_InFilePath, string m_OutFilePath, string strEncrKey)
        {
            try
            {
                byte[] byKey = null;
        ...
        /// <param name="sDecrKey">密钥</param> 
        public static void ToDesDecryptFile(this string m_InFilePath, string m_OutFilePath, string sDecrKey)
        {
            try
            {
                byte[] byKey = null;
        ...
        /// <returns></returns>
        public static string ToDESEncrypt(this string originalValue, string key, string IV)
        {
        ...
        /// <returns></returns>
        public static string ToDESDecrypst(this string data, string key, string IV)
        {
        ...
        public static string ToAES_Encrypt(this string encryptString)
        {
            return ToAES_Encrypt(encryptString, Default_AES_Key);
        }

        public static string ToAES_Decrypt(this string decryptString)
        {
            return ToAES_Decrypt(decryptString, Default_AES_Key);
        }
        ...
        public static string ToAES_Encrypt(this string encryptString, string encryptKey)
        {
        ...
        public static string ToAES_Decrypt(this string decryptString, string decryptKey)
        {
            try
            {
        ...
        /// <returns>密文</returns>  
        public static string ToAESEncryptECB(this string encryptString, string encryptKey)
        {
            try
            {
                encryptKey = GetSubString(encryptKey, 32, "");
        ...
        /// <returns>明文</returns>  
        public static string ToAESDecryptECB(this string decryptString, string decryptKey)
        {
            try
            {
                decryptKey = GetSubString(decryptKey, 32, "");
        ...
        /// <param name="fs"></param>
        /// <returns></returns>
        public static CryptoStream ToAES_EncryptStrream(this FileStream fs, string decryptKey)
        {
            decryptKey = GetSubString(decryptKey, 32, "");
            decryptKey = decryptKey.PadRight(32, ' ');
        ...
        /// <param name="fs"></param>
        /// <returns></returns>
        public static CryptoStream ToAES_DecryptStream(this FileStream fs, string decryptKey)
        {
            decryptKey = GetSubString(decryptKey, 32, "");
            decryptKey = decryptKey.PadRight(32, ' ');
        ...
        /// <returns></returns>
        public static bool ToAES_EncryptFile(this string InputFile, string OutputFile)
        {
            try
            {
                string decryptKey = "mypass";

                FileStream fr = new FileStream(InputFile, FileMode.Open);
                FileStream fren = new FileStream(OutputFile, FileMode.Create);
                CryptoStream Enfr = ToAES_EncryptStrream(fren, decryptKey);
        ...
        /// <param name="OutputFile"></param>
        /// <returns></returns>
        public static bool ToAES_DecryptFile(this string InputFile, string OutputFile)
        {
            try
            {
                string decryptKey = "mypass";
                ...
                CryptoStream Defr = ToAES_DecryptStream(fr, decryptKey);
        ...
        public static string ToEncryptByRSA(this string plaintext, string publicKey)
        {
            try
            {
        ...
        public static string ToDecryptByRSA(this string ciphertext, string privateKey)
        {
            try
            {
                UnicodeEncoding byteConverter = new UnicodeEncoding();
        ...
        {
            return ToMD5_32(input).Substring(8, 16);
        }
        /// <summary>
        /// 获得8位的MD5加密
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToMD5_8(this string input)
        {
            return ToMD5_32(input).Substring(8, 8);
        }
        /// <summary>
        /// 获得4位的MD5加密
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        public static string ToMD5_4(this string input)
        {
            return ToMD5_32(input).Substring(8, 4);
        }
        ...
        public static string ToEncryptRC4wq(this string str, string ckey)
        {
            int[] s = new int[256];
            for (int i = 0; i < 256; i++)
            {
        ...
        /// <param name="ckey">密钥</param>
        public static string ToDecryptRC4wq(this string str, string ckey)
        {
            int[] s = new int[256];
            for (int i = 0; i < 256; i++)
            {
        ...
        /// </summary>
        /// <param name="text">文本</param>
        public static string GZipDecompress(this string text)
        {
            if (string.IsNullOrEmpty(text))
                return string.Empty;
        ...
        public static byte[] GZipDecompress(this byte[] buffer)
        {
            if (buffer == null)
                return null;
            return GZipDecompress(new MemoryStream(buffer));
        }
        ...
        public static byte[] GZipCompress(this Stream stream)
        {
            if (stream == null || stream.Length == 0)
                return null;
            return GZipCompress(GZipStreamToBytes(stream));
        }
        ...
        /// </summary>
        /// <param name="stream">流</param>
        public static byte[] GZipStreamToBytes(this Stream stream)
        {
