...
namespace Silver.Net
{
    ...
    public class HttpUtil
    {
        ...
        public HttpResult GetHtml(HttpItem item)
        {
            ...
            if (item.IsToLower) result.Html = result.Html;
            return result;
        }
        ...
        /// <returns></returns>
        public (bool, T, string) AskRequest<T>(HttpItem item)
        {
            var result = GetHtml(item);
            if (result.StatusCode == HttpStatusCode.OK)
            {
                return (true, JsonConvert.DeserializeObject<T>(result.Html), "Success");
            }
            else
            {
                return (false, default(T), result.Html);
            }
        }
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public async Task<(bool, T, string)> AskRequestAsync<T>(HttpItem item)
        {
