...
namespace Silver.ArcSoft.Utils
{
    public class ImageUtil
    {
        public static Image readFromFile(string imageUrl)
        {
            ...
            {
                throw new Exception("ImageUtil.readFromFile" + ex.Message);
            }
            finally
            {
                fs.Close();
        ...
        public static ImageInfo ReadBMP(Image image)
        {
            ...
            try
            {
                ...
                my_Image = new Emgu.CV.Image<Bgr, byte>(bitmap);
            ...
            {
                throw new Exception("ImageUtil.ReadBMP" + ex.Message);
            }
            finally
            {
                if (my_Image != null)
        ...
        public static ImageInfo ReadBMP_IR(Bitmap bitmap)
        {
            ...
            {
                throw new Exception("ImageUtil.ReadBMP_IR" + ex.Message);
            }
            finally
            {
                if (my_Image != null)
        ...
        public static Image MarkRect(Image image, int startX, int startY, int width, int height)
        {
            ...
            {
                throw new Exception("ImageUtil.MarkRect" + ex.Message);
            }
            finally
            {
                g.Dispose();
        ...
        public static Image MarkRectAndString(Image image, int startX, int startY, int width, int height, int age, int gender,int showWidth)
        {
            ...
            {
                throw new Exception("ImageUtil.MarkRectAndString" + ex.Message);
            }
            finally
            {
                g.Dispose();
        ...
        public static Image ScaleImage(Image image, int dstWidth, int dstHeight)
        {
            ...
            {
                throw new Exception("ImageUtil.ScaleImage" + ex.Message);
            }
            finally
            {
                if (g != null)
        ...
        public static Image CutImage(Image src,int left,int top,int right,int bottom)
        {
            ...
            {
                throw new Exception("ImageUtil.CutImage" + ex.Message);
            } 
        }
